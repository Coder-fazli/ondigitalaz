...
function odf_get_templates(): array {
    return array(
        ...
        'service-page' => array(
            'id'          => 'service-page',
            'name'        => 'Service Page',
            'description' => 'Inline form embedded at the bottom of each service single page, replacing the static CTA card. Includes name, email, phone and message fields.',
            'trigger'     => 'odf_render_service_page_inline()',
        ...
        'about-page' => array(
            'id'          => 'about-page',
            'name'        => 'About Page',
            'description' => 'Inline form rendered in the CTA section of the About Us — New page template. Includes name, email, phone and message fields.',
            'trigger'     => 'odf_render_about_page_inline()',
...
function odf_render_templates(): void {
    ...
    if ( $edit && isset( $templates[ $edit ] ) ) {
        ...
        } elseif ( $edit === 'service-page' ) {
            odf_render_service_page_edit( $templates[ $edit ] );
        } elseif ( $edit === 'about-page' ) {
            odf_render_about_page_edit( $templates[ $edit ] );
        } else {
...
// Save service page settings AJAX
add_action( 'wp_ajax_odf_save_sp_settings', 'odf_save_sp_settings_handler' );
function odf_save_sp_settings_handler(): void {
    check_ajax_referer( 'odf_save_settings', 'nonce' );
    if ( ! current_user_can( 'manage_options' ) ) {
        wp_send_json_error( 'Unauthorized' );
    }
    ...
    $existing = get_option( 'odf_service_page_options', array() );
    $updated  = $existing;
    ...
    update_option( 'odf_service_page_options', $updated );
    wp_send_json_success( array( 'message' => 'Saved!' ) );
}

// =============================================================================
// Service Page template edit page
// =============================================================================

function odf_render_service_page_edit( array $tpl ): void {
    ...
    <div class="odf-admin-wrap">
        <div class="odf-topbar">
            ...
            <div style="display:flex;align-items:center;gap:14px;">
                <span id="odf-save-notice"></span>
                <button id="odf-save-btn" class="odf-save-btn" data-action="odf_save_sp_settings">Save Changes</button>
            </div>
        </div>
...
// Save about page settings AJAX
add_action( 'wp_ajax_odf_save_ap_settings', 'odf_save_ap_settings_handler' );
function odf_save_ap_settings_handler(): void {
    check_ajax_referer( 'odf_save_settings', 'nonce' );
    if ( ! current_user_can( 'manage_options' ) ) {
        wp_send_json_error( 'Unauthorized' );
    }
    ...
    $existing = get_option( 'odf_about_page_options', array() );
    $updated  = $existing;
    ...
    update_option( 'odf_about_page_options', $updated );
    wp_send_json_success( array( 'message' => 'Saved!' ) );
}

// =============================================================================
// About Page template edit page
// =============================================================================

function odf_render_about_page_edit( array $tpl ): void {
    ...
    <div class="odf-admin-wrap">
        <div class="odf-topbar">
            ...
            <div style="display:flex;align-items:center;gap:14px;">
                <span id="odf-save-notice"></span>
                <button id="odf-save-btn" class="odf-save-btn" data-action="odf_save_ap_settings">Save Changes</button>
            </div>
        </div>
