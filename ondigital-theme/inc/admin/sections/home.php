...
<div class="od-section active" data-section="home">
    ...
    <?php od_card_open( __( '5. Services', 'ondigital' ), 'dashicons-hammer' ); ?>
        ...
        <?php od_row_open(); ?>
            <?php od_color( 'services_card_1', __( 'Card 1', 'ondigital' ), $options, '#1a1a1a' ); ?>
            <?php od_color( 'services_card_2', __( 'Card 2', 'ondigital' ), $options, '#1c1c1c' ); ?>
            <?php od_color( 'services_card_3', __( 'Card 3', 'ondigital' ), $options, '#1e1e1e' ); ?>
            <?php od_color( 'services_card_4', __( 'Card 4', 'ondigital' ), $options, '#1a1a1a' ); ?>
            <?php od_color( 'services_card_5', __( 'Card 5', 'ondigital' ), $options, '#1c1c1c' ); ?>
        <?php od_row_close(); ?>
