...
<div class="od-section active" data-section="home">
    ...
    od_repeater( $features, 'feature', 'ondigital_features', function( $i, $row ) {
        ...
        echo '</div>';
        echo '<div class="od-lang-pane active" data-lang="en">';
        echo '<div class="od-field"><label>' . esc_html__( 'Title (EN)', 'ondigital' ) . '</label>';
        echo '<input type="text" autocomplete="off" name="ondigital_features[' . $i . '][title_en]" value="' . esc_attr( $row['title_en'] ?? $row['title'] ?? '' ) . '"></div>';
        echo '<div class="od-field"><label>' . esc_html__( 'Description (EN)', 'ondigital' ) . '</label>';
        echo '<textarea autocomplete="off" name="ondigital_features[' . $i . '][description_en]" rows="2">' . esc_textarea( $row['description_en'] ?? $row['description'] ?? '' ) . '</textarea></div>';
        echo '</div>';
        echo '<div class="od-lang-pane" data-lang="az">';
        echo '<div class="od-field"><label>' . esc_html__( 'Title (AZ)', 'ondigital' ) . '</label>';
        echo '<input type="text" autocomplete="off" name="ondigital_features[' . $i . '][title_az]" value="' . esc_attr( $row['title_az'] ?? '' ) . '"></div>';
    ...
    od_repeater( $stats, 'stats', 'ondigital_stats', function( $i, $row ) {
        $head = ( $row['number'] ?? '' ) . ( $row['suffix'] ?? '' ) . ( $row['label_en'] ?? $row['label'] ?? '' ? ' — ' . ( $row['label_en'] ?? $row['label'] ?? '' ) : '' );
        echo '<div class="od-repeater-row od-sc-row">';
        echo '<div class="od-repeater-row-head od-sc-toggle" style="cursor:pointer;user-select:none;">';
        echo '<span>' . esc_html( $head ?: sprintf( __( 'Counter %d', 'ondigital' ), $i + 1 ) ) . '</span>';
        echo '<div class="od-row-actions"><span class="od-sc-arrow" style="margin-right:8px;font-size:11px;opacity:.5;">▼</span><button type="button" class="od-remove-row">&times;</button></div></div>';
        echo '<div class="od-sc-body" style="display:none;">';
        echo '<div class="od-field-row">';
        ...
        echo '</div>';
        echo '<div class="od-lang-pane active" data-lang="en">';
        echo '<div class="od-field"><label>' . esc_html__( 'Label (EN)', 'ondigital' ) . '</label><input type="text" autocomplete="off" name="ondigital_stats[' . $i . '][label_en]" value="' . esc_attr( $row['label_en'] ?? $row['label'] ?? '' ) . '"></div>';
        echo '</div>';
        echo '<div class="od-lang-pane" data-lang="az">';
        echo '<div class="od-field"><label>' . esc_html__( 'Label (AZ)', 'ondigital' ) . '</label><input type="text" autocomplete="off" name="ondigital_stats[' . $i . '][label_az]" value="' . esc_attr( $row['label_az'] ?? '' ) . '"></div>';
        echo '</div></div>';
        echo '</div></div>';
    } );
    od_card_close();
    ...
    od_repeater( $testimonials, 'testimonial', 'ondigital_testimonials', function( $i, $row ) {
        $label = ! empty( $row['name'] ) ? esc_html( $row['name'] ) : sprintf( __( 'Testimonial %d', 'ondigital' ), $i + 1 );
        echo '<div class="od-repeater-row od-sc-row">';
        echo '<div class="od-repeater-row-head od-sc-toggle" style="cursor:pointer;user-select:none;">';
        echo '<span>' . $label . '</span>';
        echo '<div class="od-row-actions"><span class="od-sc-arrow" style="margin-right:8px;font-size:11px;opacity:.5;">▼</span><button type="button" class="od-remove-row">&times;</button></div>';
        echo '</div>';
        echo '<div class="od-sc-body" style="display:none;">';
        echo '<div class="od-lang-wrap">';
        echo '<div class="od-lang-tabs">';
        ...
        echo '</div>';
        echo '<div class="od-lang-pane active" data-lang="az">';
        echo '<div class="od-field"><label>' . esc_html__( 'Quote (AZ)', 'ondigital' ) . '</label><textarea name="ondigital_testimonials[' . $i . '][quote_az]" rows="3">' . esc_textarea( $row['quote_az'] ?? $row['quote'] ?? '' ) . '</textarea></div>';
        echo '<div class="od-field"><label>' . esc_html__( 'Role (AZ)', 'ondigital' ) . '</label><input type="text" name="ondigital_testimonials[' . $i . '][role_az]" value="' . esc_attr( $row['role_az'] ?? $row['role'] ?? '' ) . '"></div>';
        echo '</div>';
        echo '<div class="od-lang-pane" data-lang="en">';
        echo '<div class="od-field"><label>' . esc_html__( 'Quote (EN)', 'ondigital' ) . '</label><textarea name="ondigital_testimonials[' . $i . '][quote_en]" rows="3">' . esc_textarea( $row['quote_en'] ?? $row['quote'] ?? '' ) . '</textarea></div>';
        echo '<div class="od-field"><label>' . esc_html__( 'Role (EN)', 'ondigital' ) . '</label><input type="text" name="ondigital_testimonials[' . $i . '][role_en]" value="' . esc_attr( $row['role_en'] ?? $row['role'] ?? '' ) . '"></div>';
        echo '</div>';
        echo '</div>';
