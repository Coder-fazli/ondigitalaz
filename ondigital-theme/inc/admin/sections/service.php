...
<div class="od-section active" data-section="service">
    ...
    <!-- ── 1. HERO SECTION ── -->
    <?php od_card_open( __( '1. Hero Section', 'ondigital' ), 'dashicons-format-image' ); ?>
        ...
        <?php foreach ( $langs as $lang => $label ) : ?>
            <?php od_lang_pane( $lang ); ?>
                <?php od_text(     'services_hero_title_'   . $lang, __( 'Title', 'ondigital' ),            $options, __( 'e.g. Rəqəmsal dünyada fərq yaradan dizayn', 'ondigital' ) ); ?>
                <?php od_textarea( 'services_hero_body_'    . $lang, __( 'Description', 'ondigital' ),      $options, __( 'Short text below the title', 'ondigital' ) ); ?>
                <?php od_row_open(); ?>
                    <?php od_text( 'services_archive_badge_' . $lang, __( 'Badge / Eyebrow', 'ondigital' ), $options, __( 'e.g. Xidmətlər', 'ondigital' ) ); ?>
    ...
    <!-- ── 2. SERVICES GRID ── -->
    <?php od_card_open( __( '2. Services Grid', 'ondigital' ), 'dashicons-grid-view' ); ?>

        <p style="color:#646970;font-size:13px;margin:0 0 16px;"><?php esc_html_e( 'Section title + description shown above the grid, then the 4 columns.', 'ondigital' ); ?></p>
    ...
    <!-- ── 3. AGENCY BLOCK ── -->
    <?php od_card_open( __( '3. Agency Block', 'ondigital' ), 'dashicons-admin-home' ); ?>
        ...
        <?php foreach ( $langs as $lang => $label ) : ?>
            <?php od_lang_pane( $lang ); ?>
                ...
                <?php od_textarea( 'about_content_body_'     . $lang, __( 'Description', 'ondigital' ), $options ); ?>
                <?php od_row_open(); ?>
    ...
    <!-- ── 4. SEO & DEFAULTS ── -->
    <?php od_card_open( __( '4. SEO & Defaults', 'ondigital' ), 'dashicons-search' ); ?>
