...
function ondigital_customizer( $wp_customize ) {
    ...
    $footer_fields = array(
        ...
        'footer_contact_address'  => array( 'label' => __( 'Contact: Address', 'ondigital' ),               'default' => '',                                                                                                                                     'sanitize' => 'sanitize_text_field',    'type' => 'text' ),
        'footer_contact_phone'    => array( 'label' => __( 'Contact: Phone', 'ondigital' ),                  'default' => '',                                                                                                                                     'sanitize' => 'sanitize_text_field',    'type' => 'text' ),
        'footer_contact_email'    => array( 'label' => __( 'Contact: Email', 'ondigital' ),                  'default' => '',                                                                                                                                     'sanitize' => 'sanitize_email',         'type' => 'email' ),
    );
