                ...
                <div class="section-title-wrapper">
                    <div class="title-wrapper">
                        <h1 class="section-title has_fade_anim">
                            <?php printf( esc_html__( 'Axtarış nəticələri: %s', 'ondigital' ), '<span>' . get_search_query() . '</span>' ); ?>
                        </h1>
                    </div>
                </div>
            </div>
            <div class="blogs-wrapper-box">
                ...
                <?php else : ?>
                    <div class="text-wrapper">
                        <p class="text"><?php esc_html_e( 'Heç bir nəticə tapılmadı. Başqa bir axtarış sözü sınayın.', 'ondigital' ); ?></p>
                    </div>
